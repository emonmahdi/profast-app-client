...
const Merchant = () => {
  return (
    <section className=" mb-6">
      <div className="max-w-7xl mx-auto bg-[#16241d] bg-[url('assets/marchant-bg.png')] bg-no-repeat rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center gap-10 shadow-lg">
        {/* Left Section */}
        <div className="flex-1 text-white">
          ...
          <p className="text-gray-300 mb-8 text-lg">
            We help merchants deliver products fast and efficiently with full
            tracking and customer support. Your business growth is our
            responsibility.
          </p>
